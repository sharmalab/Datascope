...
var dataSource = (function() {
  ...
  //#### loadData()
  //Loads data using the type and path specified in ```config/dataSource.json```.
  //Currently supports
  // * JSON
  // * CSV
  // * REST JSON
  ...
  return {
    ...
    validate: function() {
      dataSourceSchema = JSON.parse(fs.readFileSync(
        "./schemas/dataSourceSchema.json"));
      validation = schemaValidator.validate(dataSourceConfig,
        dataSourceSchema);
    },
