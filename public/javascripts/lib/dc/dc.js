...
dc.coordinateGridMixin = function (_chart) {
    ...
    _chart.renderBrush = function (g) {
        if (_brushOn) {
            ...
            _brush.on('brushend', _chart._brushend);
...
dc.scatterPlot = function (parent, chartGroup) {
    ...
    _chart.plotData = function () {
        ...
        dc.transition(symbols, _chart.transitionDuration())
            .attr('opacity', function (d) { 
              //console.log(d);
              return _existenceAccessor(d) ? _symbolOpacity : _hiddenOpacity; 
            })
    ...
    _chart.symbolOpacity = function (symbolOpacity) {
      if(!arguments.length) {
        return _symbolOpacity;
      }
      _symbolOpacity = symbolOpacity;
      return _chart;
    };
